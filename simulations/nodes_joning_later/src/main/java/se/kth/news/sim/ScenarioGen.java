...
*/
    ...
    static Operation1<StartNodeEvent, Integer> startNodeOp2 = new Operation1<StartNodeEvent, Integer>() {
        ...
        public StartNodeEvent generate(final Integer nodeId) {
            return new StartNodeEvent() {
                ...
                {
                    selfAdr = ScenarioSetup.getNodeAdr(nodeId+92);
                }
                ...
                public Map<String, Object> initConfigUpdate() {
                    Map<String, Object> nodeConfig = new HashMap<>();
                    nodeConfig.put("system.id", nodeId+92);
                    nodeConfig.put("system.seed", ScenarioSetup.getNodeSeed(nodeId+92));
                    nodeConfig.put("system.port", ScenarioSetup.appPort);
                    return nodeConfig;
                }
            };
    ...
    static Operation1<StartNodeEvent, Integer> startNodeOp3 = new Operation1<StartNodeEvent, Integer>() {
        ...
        public StartNodeEvent generate(final Integer nodeId) {
            return new StartNodeEvent() {
                ...
                {
                    selfAdr = ScenarioSetup.getNodeAdr(nodeId+96);
                }
                ...
                public Map<String, Object> initConfigUpdate() {
                    Map<String, Object> nodeConfig = new HashMap<>();
                    nodeConfig.put("system.id", nodeId+96);
                    nodeConfig.put("system.seed", ScenarioSetup.getNodeSeed(nodeId+96));
                    nodeConfig.put("system.port", ScenarioSetup.appPort);
                    return nodeConfig;
                }
            };
...
//                        eventInterArrivalTime(uniform(0, 0));
                        eventInterArrivalTime(uniform(0, 5));
//                        eventInterArrivalTime(uniform(1000, 1100));
                        raise(4, startNodeOp2, new BasicIntSequentialDistribution(1));
                    }//How many peers are in the simulation
                };
                StochasticProcess startPeers3 = new StochasticProcess() {
                    {
//                        eventInterArrivalTime(uniform(0, 0));
                        eventInterArrivalTime(uniform(0, 5));
//                        eventInterArrivalTime(uniform(1000, 1100));
                        raise(4, startNodeOp3, new BasicIntSequentialDistribution(1));
                    }//How many peers are in the simulation
                };
                ...
                startPeers2.startAfterTerminationOf(1000*120, startPeers);
                startPeers3.startAfterTerminationOf(1000*240, startPeers);
